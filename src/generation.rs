...
const MAGNIFICATION: f64 = 25.0;
//What numbers generate water and what generates mountains. The rest of the tiles are land tiles.
const WATER_VALUES: [f64; 2] = [1.0,0.4]; //less than value 1 and greater than value 2
const MOUNTAIN_VALUES: [f64; 2] = [-0.2,-1.0]; //less than value 1 and greater than value 2
